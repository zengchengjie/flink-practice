 ...
 */
//public class ElasticsearchAsyncFunction {
public class ElasticsearchAsyncFunction extends RichAsyncFunction<Tuple4<String, String, String, Integer>, Tuple5<String, String, String, Integer,Integer>> {
    public ElasticsearchAsyncFunction(String esHost, Integer esPort, String esUser, String esPassword, String esIndex, String esType) {
    }

    @Override
    public void asyncInvoke(Tuple4<String, String, String, Integer> stringStringStringIntegerTuple4, ResultFuture<Tuple5<String, String, String, Integer, Integer>> resultFuture) throws Exception {
